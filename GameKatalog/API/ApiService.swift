...
class ApiService {
    ...
    func getDetailData(idGame: Int, completion : @escaping (Result<GameDetailData, Error>) -> Void) {
        let dataGameUrl = "https://api.rawg.io/api/games/\(idGame)?key=1104fbec0dbd4792b46f31695e71aa02"
